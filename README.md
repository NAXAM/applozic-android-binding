<img src="./art/repo_header.png" alt="Applozic for Xamarin.Android" width="728" />

# Applozic for Xamarin.Android
A Xamarin.Android binding library for [Applozic](https://github.com/AppLozic/Applozic-Android-SDK) library.
...
Plz follow its origin guide [here](https://www.applozic.com/docs/android-chat-sdk.html).

## License

Applozic binding library for Android is released under the MIT license.
...
Follow us for the latest updates<br>[![Twitter URL](https://img.shields.io/twitter/url/http/shields.io.svg?style=social)](https://twitter.com/intent/tweet?text=https://github.com/naxam/applozic-android-binding)
